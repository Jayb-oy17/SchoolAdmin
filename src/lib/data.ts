...
export const calendarEvents = [
  {
    title: "Physics",
    allDay: false,
    start: new Date(2025, 11, 8, 9, 0),
    end: new Date(2025, 11, 8, 10, 0),
  },
  {
    title: "Math",
    allDay: false,
    start: new Date(2025, 11, 8, 11, 0),
    end: new Date(2025, 11, 8, 12, 0),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 11, 8, 13, 0),
    end: new Date(2025, 11, 8, 14, 0),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2025, 11, 8, 15, 0),
    end: new Date(2025, 11, 8, 16, 0),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 11, 8, 8, 0),
    end: new Date(2025, 11, 8, 9, 0),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2025, 11, 8, 10, 0),
    end: new Date(2025, 11, 8, 11, 0),
  },
  {
    title: "Biology",
    allDay: false,
  ...
  },
  {
    ...
    end: new Date(2025, 11, 9, 14, 0),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 11, 9, 15, 0),
    end: new Date(2025, 11, 9, 16, 0),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2025, 11, 9, 8, 0),
    end: new Date(2025, 11, 9, 9, 0),
  },
  {
    title: "Math",
    allDay: false,
  ...
  },
  {
    ...
    end: new Date(2025, 11, 9, 15, 0),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2025, 11, 10, 9, 0),
    end: new Date(2025, 11, 10, 10, 0),
  },
  {
    title: "English",
    allDay: false,
  ...
  },
  {
    ...
    end: new Date(2025, 11, 11, 9, 0),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 11, 11, 9, 0),
    end: new Date(2025, 11, 11, 10, 0),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2025, 11, 11, 11, 0),
    end: new Date(2025, 11, 11, 12, 0),
  },
  {
    title: "History",
    allDay: false,
  ...
  },
  {
    title: "Computer Science",
    allDay: false,
    start: new Date(2025, 11, 12, 15, 0),
    end: new Date(2025, 11, 12, 16, 0),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 11, 12, 8, 0),
    end: new Date(2025, 11, 12, 9, 0),
  },
  {
    title: "Physics",
    allDay: false,
  ...
  },
  {
    ...
    end: new Date(2025, 11, 12, 12, 0),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 11, 13, 13, 0),
    end: new Date(2025, 11, 13, 14, 0),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2025, 11, 13, 15, 0),
